...
const GETTING_THERE = [
  ...
  },
  {
    icon: Car,
    title: 'By Road',
    desc: 'Gachibowli Indoor Stadium, Hyderabad – 500032.',
  },
  {
    icon: Navigation,
    title: 'GPS',
    desc: 'Search "Gachibowli Indoor Stadium" on Google Maps for turn-by-turn directions.',
  },
]
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1 flex items-center gap-1.5 text-sm">
            <MapPin className="w-3.5 h-3.5" /> Gachibowli Indoor Stadium, Hyderabad
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <Card className="overflow-hidden">
            <div className="relative w-full" style={{ paddingBottom: '50%' }}>
              <iframe
                title="Gachibowli Indoor Stadium, Hyderabad"
                src="https://maps.google.com/maps?q=Gachibowli+Indoor+Stadium,+Hyderabad&output=embed&z=15"
            ...
            <CardContent className="pt-4 pb-4">
              <p className="text-sm font-medium text-foreground">Gachibowli Indoor Stadium</p>
              <p className="text-xs text-muted-foreground mt-0.5">
                Gachibowli, Hyderabad, Telangana – 500032
              </p>
              <a
                href="https://maps.google.com/?q=Gachibowli+Indoor+Stadium+Hyderabad"
                target="_blank"
