...
What The Tech Hackathon at GMC Balayogi Indoor Stadium, Gachibowli, Hyderabad
...
export async function createParticipationContract({ name, email, acceptedAt }) {
  return post('', {
    ...
    description: 'Terms and conditions for participation in the Founders Fest hackathon at GMC Balayogi Indoor Stadium, Gachibowli, Hyderabad',
...
This document confirms the successful registration and payment for the Founders Fest hackathon at GMC Balayogi Indoor Stadium, Gachibowli, Hyderabad.
...
Venue: GMC Balayogi Indoor Stadium, Gachibowli, Hyderabad – 500032
