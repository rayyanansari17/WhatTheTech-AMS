...
const TEMPLATES = {
  ...
  submission_confirmed:           { C: SubmissionConfirmedEmail,        subject: "Project Submission Confirmed ✓",                          dedup: 0,  disabled: true },
  submission_updated:             { C: SubmissionUpdatedEmail,          subject: "Submission Updated",                                      dedup: 0,  disabled: true },
  warning_6hrs_submit:            { C: Warning6HrsSubmitEmail,          subject: "⏰ 6 Hours Left - Submit Your Project!",                  dedup: 20, disabled: true },
  warning_1hr_submit:             { C: Warning1HrSubmitEmail,           subject: "🚨 1 Hour Left - Submit Now!",                            dedup: 4,  disabled: true },
  submission_closed:              { C: SubmissionClosedEmail,           subject: "Submission Window Closed",                                dedup: 72, disabled: true },
  ...
  // Deposit flow
  deposit_success:          { C: DepositSuccessEmail,          subject: "Spot Reserved ✓: ₹149 deposit confirmed",               dedup: 72  },
  nudge_deposit_complete:   { C: NudgeDepositCompleteEmail,    subject: "Complete your payment to confirm your spot",             dedup: 20  },
  announce_deposit:         { C: AnnounceDepositEmail,         subject: "Reserve your spot for ₹149, pay the rest later",        dedup: 168 },
  apology_wrong_dates:      { C: ApologyWrongDatesEmail,       subject: "Important correction from What The Tech Hackathon",      dedup: 0   },
  event_postponed:          { C: EventPostponedEmail,          subject: "Important Update: What The Tech Hackathon Postponed",    dedup: 168 },
  saved_spot_apology:       { C: SavedSpotApologyEmail,        subject: "Sorry for the mixed signal -- an update on your spot",   dedup: 0   },
...
export async function triggerEmail({ type, to, userId = null, props = {} }) {
  ...
  if (template.disabled) {
    console.log(`[triggerEmail] skipping disabled type: ${type}`)
    return { skipped: true }
  }
