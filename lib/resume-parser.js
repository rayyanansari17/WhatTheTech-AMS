export function parseResumeText(text) {
  ...
  // ── Institution ────────────────────────────────────────────────────────────
  // \b on abbreviations prevents matching substrings like "nit" in "monitoring"
  const institutionMatch = text.match(
    /(?:University|Institute of Technology|Institute|College|Amity|Manipal|Osmania|\b(?:IIT|NIT|BITS|VIT|SRM|IIIT|LPU)\b)[^,\n]{0,60}/i
  )
  if (institutionMatch) {
